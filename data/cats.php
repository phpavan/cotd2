...
$_SESSION['item'][0]['caption'] = 'Adelaide Cat - Updated 1.0';
$_SESSION['item'][0]['trivia'] = "<p>I am Le Cornu and I live in Adelaide. My dad plays for the Adelaide Crows. He has a big mullet which I snuggle into when he is asleep.</p> <p style='color:silver;font-size:80%;font-style:italic'>Like me and we can watch the footie together. </p>";
